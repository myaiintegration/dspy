...
4. **Generate the DSPy book** *(optional)*: Run `python scripts/create_book.py` to assemble all educational docs into a single `BOOK.md` file. Install `nbconvert` to include notebook content:
   ```bash
